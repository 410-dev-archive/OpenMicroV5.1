...
// Motors
motor INTAKE_LEFT (vex::PORT1, vex::gearSetting::ratio18_1, false); // Param: (Port, GearSetting, Reverse);
motor INTAKE_RIGHT (vex::PORT2, vex::gearSetting::ratio18_1, false);
...
motor BALLCONVEY_UPPER(vex::PORT7, vex::gearSetting::ratio18_1, true);
